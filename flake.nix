    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
        ...
        let
          ...
          python-packages = ps: with ps; [ numpy cvxpy wheel matplotlib virtualenv uvicorn fastapi pydantic environs fastapi-cache2 pip cosmpy pendulum jsonschema grpcio ecdsa bech32 requests protobuf python-dateutil pycryptodome googleapis-common-protos ];
