...
#   filename:  response_to_get_local_asset_by_reference.json
...
class AssetReference(RootModel[Union[AssetReference9, AssetReference10]]):
    root: Union[AssetReference9, AssetReference10] = Field(
        ...,
...
class ForeignAssetId(RootModel[ForeignAssetId4]):
    root: ForeignAssetId4
